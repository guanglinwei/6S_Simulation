# Link the 6S simulation code with the .f files generated by srf_txt_to_fortran.py
...
if __name__ == '__main__':
    ...
    with open(in_main_path, 'r')  as f:
        ...
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'new_srfs.json'), 'w') as json_f:
            data = {
                'timestamp': time.time(),
                'start_band_index': comma_count,
                'new_srfs': subroutine_names
            }
